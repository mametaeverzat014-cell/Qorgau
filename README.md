...
tests/            272 tests over the engine, the product guarantees and the data pipeline
```
...
What is proven: 148 tests covering discovery, extraction, validation and both gates, plus twelve red-team
...
272 unit tests across seven suites, plus browser verification against the production build.
